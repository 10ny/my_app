...
ActiveRecord::Schema[7.0].define(version: 2023_06_02_093829) do
  ...
  create_table "beansposts", force: :cascade do |t|
    t.text "content"
  ...
  create_table "bookmarks", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "beanspost_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["beanspost_id"], name: "index_bookmarks_on_beanspost_id"
    t.index ["user_id", "beanspost_id"], name: "index_bookmarks_on_user_id_and_beanspost_id", unique: true
